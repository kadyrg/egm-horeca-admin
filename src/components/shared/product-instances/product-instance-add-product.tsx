...
function ProductInstanceAddProduct({
  instanceId,
  categories,
  variantTypes,
  variants
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    try {
      ...
      toast(<GoodToast text={"Product added successfully"} />, {
        position: "top-center",
      });
      form.reset({
        nameEn: "",
        ...
        isTop: false,
        mainImage: undefined,
        extraImage1: undefined,
        extraImage2: undefined,
        extraImage3: undefined,
        extraImage4: undefined,
        extraImage5: undefined,
        extraImage6: undefined,
      });
      setOpen(false);
    } catch {
      toast(<BadToast text={"Product couldn't be added"} />, {
        position: "top-center",
      });
    }
  }
...
export { ProductInstanceAddProduct };
